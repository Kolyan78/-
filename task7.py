'''
7. Напишите функцию search_substr(subst, st), которая принимает 2 строки и определяет, имеется ли подстрока subst в строке st.
...
def search_substr(subst, st):
    return "Есть контакт!" if st.find(subst) != -1 else "Мимо!"
